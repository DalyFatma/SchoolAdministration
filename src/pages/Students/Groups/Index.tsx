...
import { useFetchStudentsQuery, useRemoveStudentFromGroupMutation } from "features/student/studentSlice";
import { GroupInterface, useAddGroupMutation, useAddStudentToGroupMutation, useDeleteGroupMutation, useFetchGroupQuery } from "features/group/groupSlice";
...
const Group = () => {
  ...
  const DeleteStudent = async (studentId: string, groupId: string) => {
    ...
    if (confirmation.isConfirmed) {
      try {
        await deleteStudent({ studentId, groupId }); // Assuming correct usage
              ...
              <div className="noresult" style={{ display: "none" }}>
                <div className="text-center py-4">
                  ...
                  <p className="text-muted mb-0">
                    We've searched for groups and we did not
                    find any groups for you search.
                  </p>
                </div>
              </div>
            </Card.Body>
